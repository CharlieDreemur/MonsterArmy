...
public class SPUM_Manager : MonoBehaviour
{
    ...
    public UnityEngine.GameObject _drawItemObj;
    public int _drawItemIndex;
    public UnityEngine.GameObject _childItem;
    ...
    public void DrawItemProcess()
    {
        ...
        UnityEngine.GameObject ttObj2 = Instantiate(_childItem) as UnityEngine.GameObject;
        ...
        if( _drawItemIndex == 9 ) //눈의 경우
        {
            ...
            for(var i = 0 ; i < info.Length; i++)
            {
                UnityEngine.GameObject ttObj = Instantiate(_childItem) as UnityEngine.GameObject;
    ...
    public UnityEngine.GameObject _colorPicker;
    ...
    public void CheckPrefabVersionData()
    {
        if(Directory.Exists(unitPath))
        {
            ...
            foreach (FileInfo fileInfo in fileInf)
            {
                ...
                UnityEngine.GameObject prefab = AssetDatabase.LoadAssetAtPath(path, typeof(UnityEngine.GameObject)) as UnityEngine.GameObject;
                //데이터 싱크 부분
                ...
                UnityEngine.GameObject tSObj = Instantiate(_unitObjSet.gameObject);
                List<UnityEngine.GameObject> tLObj = new List<UnityEngine.GameObject>();
                ...
                UnityEngine.GameObject tObj = PrefabUtility.SaveAsPrefabAsset(tSObj, unitPath + prefab.name+".prefab");
    ...
    public List<UnityEngine.GameObject> _prefabUnitList = new List<UnityEngine.GameObject>();
        ...
        if(Directory.Exists(unitPath))
        {
            ...
            foreach (FileInfo fileInfo in fileInf)
            {
                ...
                if(tST._version == 0 || tST._version < _version)
                {
                    ...
                    UnityEngine.GameObject tObj = PrefabUtility.SaveAsPrefabAsset(_unitObjSet.gameObject, unitPath + prefab.name+".prefab");
    ...
    public void SavePrefabs()
    {
        if(_prefabUnitList.Count < _maxNumber)
        {
            ...
            UnityEngine.GameObject tObj = PrefabUtility.SaveAsPrefabAsset(tSObj, unitPath + prefabName + ".prefab");
            DestroyImmediate(tSObj);
    ...
    public UnityEngine.GameObject _loadObjCanvas;
    public Transform _loadPool;
    public List<UnityEngine.GameObject> _buttonList = new List<UnityEngine.GameObject>();
    ...
    public void OpenLoadData()
    {
        ...
        {
            UnityEngine.GameObject tObj = _prefabUnitList[j];
    ...
    {
        UnityEngine.GameObject tObj = _prefabUnitList[index];
    ...
    public UnityEngine.GameObject _noticeObj;
    public Text _noticeText;
    public List<UnityEngine.GameObject> _buttonSet = new List<UnityEngine.GameObject>();
