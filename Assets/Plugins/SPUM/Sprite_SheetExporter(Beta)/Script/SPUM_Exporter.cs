...
{
    public UnityEngine.GameObject _unitPrefab;
    ...
    public void MakeObjNow()
    {
        ...
        UnityEngine.GameObject tObj = Instantiate(_unitPrefab);
	...
	public UnityEngine.GameObject _objectNow;
	public RectTransform _imgBG;
	public UnityEngine.GameObject _bgSet;
