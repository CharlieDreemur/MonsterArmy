...
{   
    ...
    [FoldoutGroup("伤害跳字基本设置")] [HideLabel] [LabelText("正常字体大小")]
    public int noramlFontSize = 16; //正常状态的字体大小

    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("暴击字体颜色")]
    public Color critColor; //暴击状态的字体颜色

    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("暴击字体大小")]
    public int critFontSize = 20; //暴击状态的字体大小
    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("治疗字体颜色")]
    public Color healColor; //治疗状态的字体颜色

    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("治疗字体大小")]
    public int healFontSize = 16; //治疗状态的字体大小
    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("技能字体颜色")]
    public Color abilityColor; //技能状态的字体颜色

    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("技能字体大小")]
    public int abilityFontSize = 16; //技能状态的字体大小

    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("字体移动速度")]
    public float moveSpeed = 30f; //字体的移动速度

    [FoldoutGroup("伤害跳字细节设置")] [HideLabel] [LabelText("字体消失时间")]
