...
public abstract class Entity : MonoBehaviour
{
    ...
    protected ICharacterAttribute charAttr = null; //数据计算(数据变量)
    [ShowInInspector] [FoldoutGroup("角色细节数据")]
    ...
    */
    ...
    public void SetCharacterAttribute(ICharacterAttribute charAttr)
    {
    ...
    */
    ...
    {   
        ...
        int atkDamage = ICharacterAttribute.GetDamage(attacker, this, out bool IsDodge, out Enum_DamageType damageType);
        ...
        {
            Debug.Log(attacker.GetCharacterAttribute().CharacterName + "闪避了");
            //TODO: 暴击特效
        }
    ...
    IEnumerator AttackWait(float seconds, Entity attacker, Entity target)
    {
        ...
        target.UnderAttack(attacker);
    }

    IEnumerator DeathWait(float seconds)
    {
        //GameObject.Destroy(GetGameObject().GetComponent<CapsuleCollider2D>());
