...
public class HealthBarSetup : MonoBehaviour
{
    ...
    public void Init(ICharacter character){
        ...
        fixedData = charAttr.attributeData.fixedData;
        IsInit = true;
        //CopyValue(charAttr.attributeData.NowHP, fixedData.maxHP.FinalAttribute, fixedData.ShieldValue, charAttr.attributeData.NowMP, fixedData.maxMP.FinalAttribute);
    }
